...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'especialidades',
          path: '/especialidades',
          builder: (context, params) => const EspecialidadesWidget(),
        ),
        FFRoute(
          name: 'perfil',
          path: '/perfil',
        ...
        FFRoute(
          name: 'detalhesClubes',
          path: '/detalhesClubes',
          builder: (context, params) => DetalhesClubesWidget(
            detalhesClubes: params.getParam<ClubesRow>(
                'detalhesClubes', ParamType.SupabaseRow),
          ),
        ),
        FFRoute(
